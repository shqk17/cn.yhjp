		...
		$('#tb_departments').bootstrapTable({
			...
			columns: [{
				...
				formatter:function(value, row,index){
					...
					if(row.auditState){
						a='<img src= "'+rc+'/static/outSource/img/yes.jpg" style="width:15px;height:15px;">';
					}else{
						a='<img src="'+rc+'/static/outSource/img/no.jpg" style="width:15px;height:15px;">';
					}
					return a;
				}
