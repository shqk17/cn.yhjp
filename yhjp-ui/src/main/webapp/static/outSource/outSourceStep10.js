	...
	oTableInit.Init = function() {
		$('#tb_departments').bootstrapTable({
			...
			columns: [{
				...
				formatter:function(value, row,index){
					var a =""
					if(row.checkapprovalState==null){
								return a;
							}
					if(row.checkapprovalState){
						a='<img src= "'+rc+'/static/outSource/img/yes.jpg" style="width:20px;height:20px;">';
					}else{
						a='<img src="'+rc+'/static/outSource/img/no.jpg" style="width:20px;height:20px;">';
					}
					return a;
				}
			},{
				field: 'auditmountState',
				title: '<input type="checkbox" id="audit" style="margin-left:1%;"/>&nbsp金额审核',
				formatter:function(value, row,index){
